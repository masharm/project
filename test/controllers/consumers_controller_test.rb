...
class ConsumersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consumer" do
    assert_difference('Consumer.count') do
      post consumers_url, params: { consumer: { email: @consumer.email, login: @consumer.login, name: @consumer.name } }
    end
  ...
  test "should update consumer" do
    patch consumer_url(@consumer), params: { consumer: { email: @consumer.email, login: @consumer.login, name: @consumer.name } }
